...
import com.titanium.clause.command.CreateProductCommand;
import com.titanium.clause.command.UpdateProductCommand;
import com.titanium.clause.repository.InsuranceProductRepository;
...
public class InsuranceProductService {
    ...
    public InsuranceProduct createProduct(CreateProductCommand command) {
        ...
        product.setProductName(
                com.titanium.clause.valueobject.ProductName.fromString(command.productName().getValue()));
