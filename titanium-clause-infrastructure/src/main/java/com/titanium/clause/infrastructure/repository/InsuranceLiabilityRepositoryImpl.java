...
import com.titanium.clause.domain.aggregate.InsuranceLiability;
import com.titanium.clause.domain.repository.InsuranceLiabilityRepository;
...
import com.titanium.clause.infrastructure.repository.jpa.InsuranceLiabilityJpaRepository;
...
public class InsuranceLiabilityRepositoryImpl implements InsuranceLiabilityRepository {
    ...
    private InsuranceLiability toDomain(InsuranceLiabilityEntity entity) {
        ...
        liability.setName(LiabilityName.fromString(entity.getName()));
