...
import com.titanium.clause.repository.jpa.ClauseJpaRepository;
...
public class ClauseRepositoryImpl implements ClauseRepository {
    ...
    private Clause toDomain(ClauseEntity entity) {
        ...
        clause.setClauseName(com.titanium.clause.valueobject.ClauseName.fromString(entity.getClauseName()));
