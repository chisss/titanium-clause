package com.titanium.clause.query.scheduled;
 ...
 * <p>
 * 定时扫描条款读侧投影处理组的死信队列，重试因事件乱序等原因投影失败的事件序列。 处理组名须与
 * {@link com.titanium.clause.query.handler.projection.ClauseProjectionEventHandler} 的
...
public class DeadLetterQueueService {
    ...
    /** 投影处理组名，与 ClauseProjectionEventHandler 的 @ProcessingGroup 一致 */
