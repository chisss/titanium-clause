...
import com.titanium.clause.infrastructure.repository.jpa.InsuranceProductJpaRepository;
...
public class InsuranceProductRepositoryImpl implements InsuranceProductRepository {
    ...
    private InsuranceProduct toDomain(InsuranceProductEntity entity) {
        ...
        product.setProductName(ProductName.fromString(entity.getProductName()));
